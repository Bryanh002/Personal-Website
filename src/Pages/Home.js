...
function HomePage() {
    ...
    return (
      <div className="relative min-h-screen text-black">
        ...
        {/*background*/}
        <div className="fixed inset-0 bg-customBlue-100 h-screen z-[-1]"></div>
        ...
        <Element name="home" className="relative z-0 min-h-screen overflow-hidden">
          <div className="flex-grow flex flex-col items-center justify-center pt-20 pr-[1350px] fixed inset-0 h-screen z-0">
        ...
        <div className="relative bg-blue-300 h-6 shadow-xl z-20">
        ...
        <div className="relative z-10">
          <div className="bg-slate-200 h-[800px]">
            <div className="relative z-20  text-center">
              ...
              <div className="relative bg-blue-300 h-6 shadow-xl z-20"></div>
              <div className="pt-20">
              <Timeline />
              </div>
            </div>
