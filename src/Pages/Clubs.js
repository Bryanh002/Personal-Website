        ...
        <div id="clubs" className="sm:h-[1500px] h-[2200px] pt-12">
            ...
            <div ref={ref} className="w-full h-[600px] sm:h-[500px] pt-36">
                ...
                <div className="flex justify-center sm:justify-end text-start"><div className="bg-white mx-4 sm:mr-20 px-2 sm:mx-0 pb-8 sm:pb-0 w-auto h-auto sm:w-[1000px] sm:h-48 mt-10 rounded-lg shadow-md">
                    ...
                    <p className="ml-10 mr-10 font-serif pt-5 ">During my time with Western AERO design club I was taught how to code a react.js front-end for displaying data and how to pair it with an MongoDB database for storing said data, I also created a docker file to allow the program to be user friendly. They also taught me basic PCB design and soldering for electrical components. </p>
                </div></div>
                </div>
            </div>
