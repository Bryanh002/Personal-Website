...
function ProjectPage() {
    ...
    return(
        ...
        <div id="projects" className="h-[2000px] sm:h-[1600px] text-white">
            ...
            {/* Desktop Menu */}
            <div className="hidden text-black fixed top-0 sm:flex sm:justify-end space-x-8 text-lg font-semibold mb-10 w-full p-2 pb-4 pr-2 pt-4 bg-white shadow-lg z-20">
            <nav>
            ...
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="sm:hidden text-black bg-white shadow-lg p-4 absolute top-[60px] left-0 w-full z-20">
                    ...
                    <div className="h-full w-full flex flex-col">
                        <div className={`flex justify-center sm:px-20 px-5 ${isFActive ? 'hidden' : 'visible'} ${isAiActive ? 'hidden' : 'visible'}`}>
                                <div id="robotic-arm" className="mt-14 sm:h-96 w-full h-[400px] rounded-lg flex flex-col sm:flex-row ease-in-out duration-300">
                                    ...
                                    <div className="tracking-wide w-full md:w-[850px] md:mt-16 font-bold font-serif text-lg lg:text-2xl md:text-left text-center">
                                        <p>IOT Robot Arm:</p>
                                        <p className="font-normal leading-relaxed text-sm md:hidden">I built a robotic arm with 6 Degrees of freedom and controlled it with a bluetooth app!</p>
                                        <p className="font-normal leading-relaxed lg:text-lg text-base hidden md:block">
                                        ...
                                        <button className="mt-20 text-lg hidden xl:block" onClick={handleRobotButtonClick}>Click to Learn More</button>
                                    </div>
                                </div>
                        </div>
                        ...
                        <div className={`flex justify-center sm:px-20 px-5 ${isRActive ? 'hidden' : 'visible' } ${isAiActive ? 'hidden' : 'visible' }`}>
                            <div id="Financial Website" className="mt-14 sm:h-80 w-full h-[400px] rounded-lg flex flex-col sm:flex-row ease-in-out duration-300">
                                ...
                                <div className="w-full  tracking-wide md:w-[850px] md:mt-14 mb-16 md:mb-0 font-bold font-serif text-lg lg:text-2xl md:text-left text-center">Financial Management Website: 
                                    <p className="font-normal leading-relaxed text-sm md:hidden">I created a full-stack application for managing funds, investments, checking crypto and stock prices and also financial news articles. This was done with the use of a python backend utilizing multiple API's</p>
                                    <p className="font-normal leading-relaxed lg:text-lg text-base hidden md:block">For this project I created a full-stack application that allows the user to manage their bank accounts and investments using the plaid API, they can also check any stock and crypto prices in real-time, as well as easily view financial news. The front-end was created using react-js, and the back-end utilized python with a flask framework for sending API requests.</p>
                        ...
                        <div className={`flex justify-center sm:px-20 px-5 ${isFActive ? 'hidden' : 'visible' } ${isRActive ? 'hidden' : 'visible' }`}>
                            <div id="Ai-project" className=" mt-14 sm:h-80 w-full h-[400px] rounded-lg flex flex-col sm:flex-row ease-in-out duration-300">
                                ...
                                <p className="font-normal leading-relaxed text-sm md:hidden">I trained and fine-tuned a computer vision model based off of the YOLOv3 research paper, this involved understanding the concepts of the paper and applying them. I  managed to retain a mean average precision of 51.2% compared to YOLOv3's 57.9%</p>
                                <p className="font-normal leading-relaxed lg:text-lg text-base hidden md:block">For this project I used a pre-made dataset to train my own computer vision model completely based off of the YOLOv3 research paper. This project involved reading and understanding the concepts and techniques in the paper for training weights, understanding model architecture, training the model, setting loss functions, model evaluation and last but not least optimizing and fine-tuning the model. This project was quite successful as I was able to retain a mean average precision of 51.2% compared to YOLOv3's 57.9% </p>
